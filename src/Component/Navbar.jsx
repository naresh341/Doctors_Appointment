...
const Navbar = () => {
    ...
    //we are using token show that we are login or logout
    const [token, setToken] = useState(true)
  return (
    <>
    <div className='caret-transparent flex item-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
