...
const Login = () => {
  ...
  return (
    <>
    <form className='min-h-[80dvh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-xl'>
        ...
        <div className='w-full'>
        <p>PASSWORD</p>
        <input  className='border border-zinc-300 rounded w-full p-2 mt-1 ' type="password" onChange={(e)=>setPassword(e.target.value)} value={name} />
        </div>
