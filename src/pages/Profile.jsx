  ...
  return (
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      <img className='w-36 rounded ' src={userData.image} alt="image" />
        {
          edit
        ? <input className='bg-grey-50 text-2xl font-mdeium max-w-60 mt-4' type="text" value={userData.name} onChange={(e)=>setUserData(prev=>({...prev,name:e.target.value}))} /> 
        ...
        <p className='font-medium'>Address:</p>
        {
          edit?
           <p>
            <input className='bg-gray-50' onChange={(e)=>setUserData(prev=>({...prev.address,line1:e.target.value}))} 
            type="text" value={userData.address.line1} />   
            <br />
            <input className='bg-gray-50' onChange={(e)=>setUserData(prev=>({...prev.address,line2:e.target.value}))} 
